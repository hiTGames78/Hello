...
# Configuration
ADMIN_IDS = {5963690351}  # Replace with your actual admin user ID(s)
...
target_ip = None
target_port = None
attack_time = 20000  # Default time
threads = 70  # Default thread count
...
def main():
    ...
    TOKEN = "8111644363:AAFgTzgQ2-_NxJ-DrYunuePLIm7cAgkIXsQ"
